...
if (isset($_POST['userconv']) && isset($_POST['passconv'])){
	...
	// VERIFICA SENHA ******************************************************************************************************************************************************
    $sql_conv_senha = $pdo->query("SELECT usuario_texto, password, cod_convenio FROM sascard.c_senhaconvenio WHERE usuario_texto='".$usuario_x."' AND password='".$password_x."'");
