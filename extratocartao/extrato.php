...
$sql = "SELECT * FROM sascard.usuarios where email = :email";
$mes_atual = "";
$n_cartao = "";
$n_senha = "";
if (isset($_POST['autorizado'])){
    ...
    if($txtSenhaCartao != 0){
        ...
        $sql_pede_senhax = $pdo->query("SELECT * FROM sascard.c_senhaassociado WHERE cod_associado = '" . $Codigo . "' and id_empregador=".$Empregador);
        ...
        if($txtSenhaCartao == $n_senha){
            ...
            if ($cod_situacaocartao == "1" or $cod_situacaocartao == "5" or $cod_situacaocartao == "4" or $Codigo == "172561" or $Codigo == "270435") {
                $bloqueado_uso = 'NAO';
            } else {
                //$bloqueado_uso = 'SIM'; //ESTAVA FUNCIONADO ASSIM BLOQUADO PARA QUEM TEM CARTAO BLOQUEADO
                $bloqueado_uso = 'SIM';
            }
            $sql_senha_associadox = $pdo->query("SELECT cod_associado, senha FROM sascard.c_senhaassociado WHERE cod_associado = '$n_associado' AND senha = '$txtSenhaCartao'");
                ...
                <form name="listagem" method="post"
                    ...
                    <tr>
                        <td colspan="6" bordercolor="E9E9E9"><p align="center"
                                ...
                                EXTRATO SIMPLIFICADO DO CARTAO SASCARD <br/>
                            </p>
                            <p align="left">
                    ...
                    $sql_extrato_cartaox = $pdo->query("SELECT data, hora, valor, parcela, razaosocial, 
                                                                       cod_verificacao, mes, nome FROM sascard.qextratocartao 
