...
if (isset($_POST["matricula"]) and $_POST["matricula"] != "") {
        ...
        RIGHT JOIN (sascard.convenio RIGHT JOIN sascard.conta ON convenio.codigo = conta.convenio) 
...
PDF::setPG($pagina);
// SOMAS DA ULTIMA PAGINA **********************************************
$pdf->Cell(60, 10, "GASTOS", 0, 0, 'R');
$pdf->Cell(30, 10, "DESCONTOS", 0, 0, 'R');
$pdf->Ln(6);

$pdf->Cell(40, 10, "COMPRAS : ", 0, 0, 'R');
$pdf->Cell(18, 10, number_format($compras, "2", ",", "."), 0, 0, 'R');
$pdf->Cell(30, 10, number_format($compras-$cnd, "2", ",", "."), 0, 0, 'R');
$pdf->Ln(5);

$pdf->Cell(40, 10, "FARMACIA : ", 0, 0, 'R');
$pdf->Cell(18, 10, number_format($farmacia, "2", ",", "."), 0, 0, 'R');
$pdf->Cell(30, 10, number_format($farmacia-$fnd, "2", ",", "."), 0, 0, 'R');
$pdf->Ln(5);

$pdf->Cell(40, 10, "FINANCEIRA : ", 0, 0, 'R');
$pdf->Cell(18, 10, number_format($emprestimo, "2", ",", "."), 0, 0, 'R');
$pdf->Cell(30, 10, number_format($emprestimo-$endes, "2", ",", "."), 0, 0, 'R');
$pdf->Ln(5);

$pdf->Cell(40, 10, "UNIMED : ", 0, 0, 'R');
$pdf->Cell(18, 10, number_format($unimed, "2", ",", "."), 0, 0, 'R');
$pdf->Cell(30, 10, number_format($unimed-$dnd, "2", ",", "."), 0, 0, 'R');
$pdf->Ln(6);

$pdf->Cell(40, 10, "Total : ", 0, 0, 'R');
$pdf->Cell(18, 10, number_format($total, "2", ",", "."), 0, 0, 'R');
$pdf->Cell(30, 10, number_format(($compras+$farmacia+$emprestimo+$unimed)-($cnd+$fnd+$endes+$dnd), "2", ",", "."), 0, 0, 'R');
$total = 0;
