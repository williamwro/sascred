...
FROM sascard.associado RIGHT JOIN (sascard.c_situacaocartao RIGHT JOIN sascard.c_cartaoassociado ON c_situacaocartao.id = c_cartaoassociado.cod_situacaocartao) ON associado.codigo = c_cartaoassociado.cod_associado ORDER BY associado.nome";
