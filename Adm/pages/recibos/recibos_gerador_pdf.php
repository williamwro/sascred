...
while($row = $sql_conv_vendas->fetch()) {
    ...
    $y = $pdf->GetY();
    $pdf->SetXY(10,$y);
    $corpo_recibo = utf8_decode("                    Recebemos do Sindicato dos Funcionários da Prefeitura Municipal de Varginha MG, das Autarquias e Fundações Municipais, a importancia de R$ ").$total_liquido." ( ".utf8_decode($extenso->converter($total_liquido2))." )"
