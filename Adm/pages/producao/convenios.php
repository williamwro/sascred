...
$query = "SELECT E.codigo,
                 ...
                 E.cobranca, 
                 E.desativado
            FROM sascard.conta AS C 
      INNER JOIN sascard.empregador as S ON C.empregador = S.id
	  INNER JOIN sascard.divisao as D ON S.divisao = D.id_divisao
	  INNER JOIN sascard.convenio AS E ON C.convenio = E.codigo
