...
if(isset($_POST["cod_associado"])){
    ...
    $query = "SELECT * FROM sascard.associado WHERE codigo = '".$cod_associado."' AND empregador = ".$id_empregador;
    ...
    $query = "SELECT * FROM sascard.c_senhaassociado WHERE cod_associado = '".$cod_associado."' AND id_empregador = ".$id_empregador;
