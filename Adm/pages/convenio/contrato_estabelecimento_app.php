...
<div class="container">
    <div class="box">
		...
		<DIV TYPE=HEADER>
			...
			<IMG SRC="logo_sascred.png" NAME="graphics1" ALIGN=LEFT HSPACE=12 WIDTH=70 HEIGHT=67 BORDER=0>
            <FONT FACE="Century Gothic, sans-serif"><FONT SIZE=2>SASCONVENIO SISTEMA DE ASSISTENCIA
            SOCIAL POR CONVENIOS LTDA, </FONT></FONT>
			</P>
			<P LANG="pt-BR" ALIGN=CENTER STYLE="text-indent: 0.98in; margin-bottom: 0in;margin-top: 0in;">
			<FONT FACE="Century Gothic, sans-serif"><FONT SIZE=2>   </FONT></FONT></P>
			<P LANG="pt-BR" ALIGN=CENTER STYLE="text-indent: 0.98in; margin-bottom: 0in;margin-top: 0in;">
			<FONT FACE="Century Gothic, sans-serif"><FONT SIZE=2>CNPJ :
            21.953.683/0001-71,</FONT></FONT></P>
			<P LANG="pt-BR" ALIGN=CENTER STYLE="text-indent: 1.00in; margin-bottom: 1.30in;margin-top: 0in;">
			<FONT FACE="Century Gothic, sans-serif"><FONT SIZE=2>Av. Antártica, Nº 568 – Agua Branca,
            CEP 05003-020, SÃO PAULA/SP</FONT></FONT></P>
		</DIV>
		...
		DE CREDENCIAMENTO AO CONVÊNIO</U></FONT></FONT></P>

		<P LANG="pt-BR" CLASS="western" ALIGN=CENTER STYLE="margin-bottom: 0in">
		<BR>
		</P>
		<P LANG="pt-BR" CLASS="western" ALIGN=JUSTIFY STYLE="margin-bottom: 0in">
		<font FACE="Century Gothic, sans-serif"><B>Sasconvenio Sistema de Assistencia
        Social por Convenios Ltda</B>, inscrita no CNPJ/MF sob o nº
		21.953.683/0001-71, com sede administrativa na cidade de São Paulo/SP
		na Av. Antártica, Nº 568 – Agua Branca, doravante denominada <B>CONVENIO
    	SASCRED</B> e <B><?PHP echo $_GET['razaosocial']; ?></B>, <?PHP echo $cnpjorcpftexto; ?>, <?PHP echo $cnpjorcpf; ?>
		...
		cartão SASCRED e APLICATIVO denominados CARTÃO DO CONVENIO
		SASCRED que venham a ser utilizados por trabalhadores associados ao
		CONVENIO SASCRED.</FONT></P>
		...
		serviços aos titulares do cartão, CONVENIO SASCRED; </FONT>
		</P>
		<P LANG="pt-BR" CLASS="western" ALIGN=JUSTIFY STYLE="margin-bottom: 0in">
		...
		CONVENIO SASCRED no comprovante de compra emitido pelo sistema web
		...
		O CONVENIO SASCRED compromete se a Implantar, organizar, manter e
		...
		serviços através de transferencia bancária;</FONT></P>
			<DIV TYPE=FOOTER>
				<P LANG="pt-BR" ALIGN=CENTER STYLE="margin-top: 0.2in; margin-bottom: 0in">
					<FONT FACE="Century Gothic, sans-serif"><FONT SIZE=1 STYLE="font-size: 8pt">Av. Antártica, Nº 568 – Agua Branca - São Paulo/SP</FONT></FONT></P>
				<P LANG="pt-BR" ALIGN=CENTER STYLE="margin-bottom: 0in"><FONT FACE="Century Gothic, sans-serif"><FONT SIZE=1 STYLE="font-size: 8pt">(11) 3199-0106
					</FONT></FONT></P>
			</DIV>
		</section>
		<section class="sheet padding-10mm">
		...
		CONVENIO SASCRED não irá fazer o repasse dos valores dos produtos
		...
		SASCRED </FONT><FONT COLOR="#000000"><FONT FACE="Courier New, monospace"><FONT SIZE=3><SPAN STYLE="font-style: normal"><SPAN STYLE="font-weight: normal"><FONT FACE="Century Gothic, sans-serif">é
		...
		<P LANG="pt-BR" CLASS="western" STYLE="margin-bottom: 0in"><FONT FACE="Century Gothic, sans-serif">	</FONT></P>
		<P LANG="pt-BR" CLASS="western" ALIGN=CENTER STYLE="margin-bottom: 0in">
		<FONT FACE="Century Gothic, sans-serif">CONVENIO SASCRED</FONT></P>
		<P LANG="pt-BR" CLASS="western" STYLE="margin-bottom: 0in"><BR>
		</P>
		<P LANG="pt-BR" CLASS="western" ALIGN=JUSTIFY STYLE="margin-bottom: 0in">
		<BR>
