...
class PDF_WriteTag extends FPDF
{
    ...
    {
        // Logo
        $this->Image('logo_sascred.png',18,8,20);
        // Arial bold 15
        $this->SetFont('Arial','B',8);
        $this->Ln(3);
        $this->SetTextColor(0,0,156);
        $this->Cell(54);//move para direita 20 posiçoes
        $this->Write(0,utf8_decode('SASCONVENIO SISTEMA DE ASSISTENCIA SOCIAL POR CONVENIOS LTDA,'));
        $this->Ln(4);
        ...
        $this->Write(0,utf8_decode('CNPJ: 21.953.683/0001-71'));
...
// Page footer
    function Footer()
    {
        ...
        $this->Cell(0,10,'Av Antartica, 568 - Água Branca',0,0,'C');
        $this->Ln(3);
        $this->Cell(0,10,'São Paula - SP',0,0,'C');
...
$pdf->Ln(13);
$titulo = utf8_decode("<h1>CONTRATO DE CREDENCIAMENTO AO CONVÊNIO</h1>");
$pdf->WriteTag(0, 4,$titulo,0,'C',0,0);
$pdf->Ln(13);

$y = $pdf->GetY();
$pdf->SetXY(10,$y);
$objeto = utf8_decode("<p>Sasconvenio Sistema de Assistencia Social por Convenios Ltda, inscrita no CNPJ/MF sob o nº 17.680.975/0001-00, com sede administrativa na cidade de São Paulo/SP na Av. Antártica, No 568 – Agua Branca, doravante denominada <vb>CONVENIO SASCRED</vb> e ".$razaosocial." ".$cnpjorcpftexto.$cnpjorcpf.", com sede administrativa na cidade de $cidade - $estado, na $endereco, $numero - $bairro $complemento, doravante denominada <vb>CONVENIADO</vb>.</p>
                            <p>OBJETO DO CONTRATO. O presente contrato tem por objeto o credenciamento do 
                               ESTABELECIMENTO ao SISTEMA de cartão CONVENIO SASCRED, através do 
                               recebimento, aceitação e/ou utilização pelo ESTABELECIMENTO, do cartão SASCRED e 
                               APLICATIVO denominados CARTÃO DO CONVENIO SASCRED que venham a ser 
                               utilizados por trabalhadores associados ao CONVENIO SASCRED.</p>
                            <p><vb>1º</vb> O CONVENIADO está autorizado a fornecer produtos e prestação de serviços aos 
                               titulares do cartão, CONVENIO SASCRED;</p>
                            ...
                            <p><vb>3º</vb> O CONVENIADO deverá exigir assinatura do portador do cartão CONVENIO 
                               SASCRED no comprovante de compra emitido pelo sistema web ou no cupom fiscal ou 
                               qualquer documento que comprove o fornecimento de produtos e serviços;</p>
                            <p><vb>4º</vb> O CONVENIO SASCRED compromete se a Implantar, organizar, manter e 
                            ...
                            <p><vb>6º</vb> O CONVENIADO receberá o pagamento das vendas ou prestação de serviços 
                               através de transferencia bancária, após 30 dias da data de fechamento do convenio;</p>");
...
$objeto = utf8_decode("<p><vb>7º</vb> O CONVENIADO poderá definir o preço praticado na venda de produtos ou 
                            ...
                            <p><vb>9º</vb> O CONVENIO SASCRED não irá fazer o repasse dos valores dos produtos ou 
                            ...
                            <p><vb>10º</vb> A Taxa administrativa do cartão CONVENIO SASCRED é de (4,0%);</p>
                            <p><vb>11º</vb> O CONVENIADO tem duas opções para lançar os valores no sistema, através do 
                               site https://www.sascred.makecard.com.br, ou através do Aplicativo disponível para androide no GooglePlay;</p>
                            ...
                            <p><vb>15º</vb> As partes elegem o foro da Comarca de Sao Paulo-SP, para dirimir qualquer 
                               controvérsia em razão do presente instrumento.</p>");

$pdf->WriteTag(180, 6.5, $objeto,0,'J',0,0);

$pdf->Ln(8);
$objeto = "<p><p>São Paulo, ".$data_cadastro.".</p></p>";
$pdf->WriteTag(180, 6, $objeto,0,'J',0,0);

$pdf->Ln(4);
$objeto = "<p><p>CONVENIO SASCRED</p></p>";
...
function enviar_email($caminho,$email_convenio,$nome_convenio){
    try {
        ...
        $mail->Subject = 'Contrato convenio Sascred';
                                        ...
                                        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" style=\"border: 1px solid #cccccc; border-collapse: collapse;\">
                                            <tr style=\"border-bottom:1px solid #cccccc;\">
                                                <td align=\"center\" bgcolor=\"#ffffff\" style=\"padding: 40px 0 20px 0; color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;\">
                                                    <img src=\"https://sascred.makecard.com.br/Adm/pages/convenio/logo_sascred.png\" alt=\"Contrato\" width=\"100\" height=\"90\" style=\"display: block;\" />
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">
                                                        <tr>
                                                            <td style=\"color: #153643; font-family: Arial, sans-serif; font-size: 24px;\">
                                                                <b>Contrato do convenio Sascred</b>
                                                            </td>
                                                        </tr>
                                                        <tr>
...
$sql = "UPDATE sascard.convenio SET ";
