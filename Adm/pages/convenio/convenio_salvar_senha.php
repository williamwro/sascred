...
if(isset($_POST['codigo_convenio'])){
    ...
    $sql = "SELECT * FROM sascard.c_senhaconvenio WHERE cod_convenio = :codigo_convenio";
    ...
    try {
        ...
        if($_existe_senha=="nao"){
            ...
            $sql = "INSERT INTO sascard.c_senhaconvenio(cod_convenio, usuario, senha, usuario_texto) ";
            ...
            $sql = "UPDATE sascard.c_senhaconvenio SET ";
            $sql .= "usuario = :usuario, ";
            $sql .= "senha = :senha, ";
