...
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $someArray = array();
    $i=0;
    $sql = $pdo->query("SELECT convenio.codigo, convenio.razaosocial, convenio.nomefantasia, convenio.endereco, convenio.bairro, convenio.cidade, convenio.cep, convenio.telefone, convenio.email, categoriaconvenio.nome AS nome_categoria, categoriaconvenio.codigo AS codigo_categoria
                                FROM sascard.categoriaconvenio 
