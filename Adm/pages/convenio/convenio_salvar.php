...
$_cobranca = isset($_POST['C_cobranca']) ? (int)1 : (int)0;
$_desativado = isset($_POST['C_desativado']) ? (int)1 : (int)0;
$_pede_senha = 1;
$stmt = new stdClass();
...
if(isset($_POST["operation"])) {
    if($_POST["operation"] == "Update") {
        ...
        $sql = "INSERT INTO sascard.convenio( ";
        $sql .= "razaosocial, nomefantasia, endereco, numero, bairro, cidade, uf, cep, telefone, fax, cel, tipo, contato, prolabore, prolabore2, cnpj, cpf, insc, id_categoria, ";
        $sql .= "id_categoria_recibo, n_parcelas, registro, situacao, divulga, email, email2, insc_mun, tipo2, cobranca, desativado, pede_senha) VALUES( ";
        $sql .= ":razaosocial, ";
        $sql .= ":nomefantasia, ";
        $sql .= ":endereco, ";
        $sql .= ":numero, ";
