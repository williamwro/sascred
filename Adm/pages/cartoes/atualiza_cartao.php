...
if($_POST['cartao']){
    if($_POST['cartao'] != "") {
        ...
        $sql = "UPDATE sascard.c_cartaoassociado SET cod_situacaocartao = :cod_situacao WHERE cod_verificacao = :cod_verificacao ";
        ...
        $sql2 = "INSERT INTO sascard.c_historico_cartoes(matricula,cod_verificacao,cod_situacaocartao,data,hora,usuario,obs,id_empregador)";
        $sql2 .= " VALUES(";
        $sql2 .= ":matricula, ";
