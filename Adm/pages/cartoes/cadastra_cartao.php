...
for ($i=1;$i<100;$i++) {
    $query = "SELECT * FROM sascard.c_cartaoassociado WHERE cod_verificacao = '".$_cartao."'";
...
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    $sql = "INSERT INTO sascard.c_cartaoassociado(cod_situacaocartao,cod_associado,cod_verificacao,empregador,data_pedido,id_divisao)";
    $sql .= " VALUES(";
