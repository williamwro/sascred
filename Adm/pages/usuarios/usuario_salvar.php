...
if(isset($_POST["operation"])) {
    if($_POST["operation"] == "Update") {
        if($C_senha != "") {
            $sql = "UPDATE sascard.usuarios SET ";
        ...
        $sql = "INSERT INTO sascard.usuarios( ";
        ...
        $sql_menu = "SELECT * FROM sascard.dynamic_menu ORDER BY id";
        ...
        foreach ($result as $row) {
            ...
            $sql2 = "INSERT INTO sascard.usuarios_menu( ";
...
function getFuncao_enviar_email($email)
{
    ...
    $stmt = new stdClass();
    $pdo = Banco::conectar_postgres();
    $sql = "SELECT codigo,senha,email,nome FROM sascard.usuarios WHERE email = :email";
    $stmt = $pdo->prepare($sql);
    ...
    if($rs > 1){
        ...
        foreach ($result as $row) {
            ...
            $link = '<a href="http://127.0.0.1/sind/alterar_senha.php?chave=' . $chave . '">http://127.0.0.1/sind/alterar_senha.php?chave=' . $chave . '</a>';
            $nome = $row['nome'];
        }
        try {
            //Server settings
                                        ...
                                        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" style=\"border: 1px solid #cccccc; border-collapse: collapse;\">
                                            <tr>
                                                <td align=\"center\" bgcolor=\"#f5f5dc\" style=\"padding: 40px 0 20px 0; color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;\">
                                                    <img src=\"http://127.0.0.1/sind/makecard.png\" alt=\"Creating Email Magic\" width=\"280\" height=\"90\" style=\"display: block;\" />
                                                </td>
                                            </tr>
                                            <tr>
