...
$total_liquido = 0;
$stmt = new stdClass();
$query = "SELECT nome_convenio as descri,sum(valor) as total,prolabore,prolabore2,residuo,acrescimo,divisao,cod_convenio,email,controle,id_categoria_recibo FROM sascard.qextrato WHERE mes = '" . $_POST["mes"] ."' AND divisao = ".$divisao."AND cobranca = true GROUP BY nome_convenio,divisao,prolabore,prolabore2,acrescimo,cod_convenio,residuo,email,controle,id_categoria_recibo ORDER BY nome_convenio";
...
while($row = $statment->fetch()) {
    ...
    $sql = "INSERT INTO sascard.cobranca(";
