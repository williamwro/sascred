...
<head>
    <meta charset="utf-8">
    <title>SasMed | Administrador</title>
    <!-- Tell the browser to be responsive to screen width , maximum-scale=1, user-scalable=no-->
    ...
    <link rel="stylesheet" href="../css/dataTables.checkboxes.min.css"/>
    ...
    <style type="text/css">
        ...
        #select2-C_Banco-container{
            margin-top: -7px;
            margin-left: -10px;
            width: 403px;
        }
        #select2-C_Tipo_Conta-container{
            margin-top: -7px;
            margin-left: -10px;
        }
...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-mini"><b>S</b>MED</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>S</b>AS MED</span>
        </a>
        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" onclick="location.href ='../index.html'" class="dropdown-toggle" data-toggle="dropdown">Sair</a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            $hasil=$pdo->query("SELECT dynamic_menu.id as menu_item_id,
                                  ...
                                  FROM sascard.usuarios_menu
                            RIGHT JOIN sascard.dynamic_menu 
                                    ON dynamic_menu.id = usuarios_menu.id_menu
                                 WHERE usuarios_menu.codigo_usuario = ".$cod_usuario." ORDER BY dynamic_menu.menu_order");
            $refs = array();
            $list = array();
    ...
    <footer class="main-footer">
        ...
        <strong>SasMed 2022.</strong> All rights
        reserved.
    </footer>
    <!-- Control Sidebar -->
...
<script src="https://cdn.jsdelivr.net/npm/jquery-datatables-checkboxes@1.2.13/js/dataTables.checkboxes.min.js" type="text/javascript" ></script>
