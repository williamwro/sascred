...
if($rs == 1){
    ...
    foreach ($result as $row) {
        ...
        $link = '<a href="https://sascred.makecard.com.br/alterar_senha.php?chave=' . $chave . '&user='.$usuario.'">https://sascred.makecard.com.br/alterar_senha.php?chave=' . $chave . '&user='.$usuario.'</a>';
        $nome = $row['nome'];
    }
                                        ...
                                        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" style=\"border: 1px solid #cccccc; border-collapse: collapse;\">
                                            <tr>
                                                <td align=\"center\" bgcolor=\"#f5f5dc\" style=\"padding: 40px 0 20px 0; color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;\">
                                                    <img src=\"https://sascred.makecard.com.br/makecard.png\" alt=\"Creating Email Magic\" width=\"280\" height=\"90\" style=\"display: block;\" />
                                                </td>
                                            </tr>
                                            <tr>
